...
const Home = async () => {
    ...
    let html = posts.map(post => {
      ...
      newPost.innerHTML = `
              ...
              <div class="btn-group">
                  ...
                  <button class="edit-post-btn" style="display: ${post.creator._id === userId ? 'block' : 'none'}">edit</button>
                  <button class="delete-post-btn" style="display: ${post.creator._id === userId ? 'block' : 'none'}">delete</button>
              </div>
          `
  ...
  window.addEventListener('scroll', () => {
    ...
    let isScrollToBottom = scrollTop + clientHeight >= scrollHeight - 5 ? true : false
